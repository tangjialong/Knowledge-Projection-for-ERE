...
class DataProcessor(object):
    ...
    def get_examples(self, data_dir, set_name):#works for differently for train!
        ...
        file_names = {
                ...
                # "wscr-train": "train.c_together.txt", # BEET-ASER
                # "wscr-train": "ASER-output-core", # BEET-ASER (Our reimplementation)
                # "wscr-train": "ASER-enriched-bert_classifier", # BERT-Eriched (BERT-classifier)
                # "wscr-train": "ASER-enriched-bert_emt", # BERT-Eriched (BERT-EMT)
